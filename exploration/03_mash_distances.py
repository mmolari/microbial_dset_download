...
# histogram of mash distances
plt.figure(figsize=(8, 6))
sns.histplot(
    df.values.flatten(),
    stat="density",
)
plt.title("Distribution of Mash Distances")
plt.xlabel("Mash Distance")
plt.ylabel("Density")
plt.tight_layout()
plt.show()

# cumulative distributions of distances for 20 most common sequence types
...
plt.title("Cumulative Distribution of Mash Distances by Sequence Type")
